...
reg [64-1:0] dma_rd_rsp_data_d1;
reg [64-1:0] dma_rd_rsp_data_d2;
...
always @(posedge nvdla_core_clk or negedge nvdla_core_rstn) begin
    if (!nvdla_core_rstn) begin
        dma_rd_rsp_data_d1 <= 'b0;
    end else begin
        dma_rd_rsp_data_d1 <= dma_rd_rsp_data;
    end
end
always @(posedge nvdla_core_clk or negedge nvdla_core_rstn) begin
    if (!nvdla_core_rstn) begin
        dma_rd_rsp_data_d2 <= 'b0;
    end else begin
        dma_rd_rsp_data_d2 <= dma_rd_rsp_data_d1;
    end
end
////////////////////////////////////////////////////////////////////////
...
assign dc2cvt_dat_wr_addr = cbuf_wr_addr_0;
assign dc2cvt_dat_wr_data = dma_rd_rsp_data_d2;;

// assign dc2cvt_dat_wr_en = cbuf_wr_en_d3;
assign dc2cvt_dat_wr_en = cbuf_wr_en;
assign dc2cvt_dat_wr_info_pd = {{3{1'b0}}, cbuf_wr_en};
