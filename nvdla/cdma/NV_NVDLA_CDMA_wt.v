...
input [12:0] reg2dp_weight_kernel_dwc;
...
wire [12:0] incr_wt_kernels_d0;
wire [12:0] incr_wt_kernels_w;
...
assign is_int8 = 1'b1;
assign is_fp16 = 1'b0;
//assign weight_kernel = is_dwc ? reg2dp_weight_kernel_dwc : reg2dp_weight_kernel;
//: my $atmk = 8;
...
assign incr_wt_kernels_w = is_dwc ? (reg2dp_weight_kernel_dwc + 1'b1) : (~status_last_group) ? 13'd8 : (reg2dp_weight_kernel[3-1:0] + 1'b1);
always @(posedge nvdla_core_clk or negedge nvdla_core_rstn) begin
   if (!nvdla_core_rstn) begin
       incr_wt_updt <= 1'b0;
   end else begin
