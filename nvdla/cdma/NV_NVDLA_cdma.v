...
wire [12:0] reg2dp_weight_kernel_dwc;
...
NV_NVDLA_CDMA_regfile u_regfile (
  ...
  ,.reg2dp_d1_op_en (reg2dp_d1_op_en)
  ...
  ,.reg2dp_weight_kernel_dwc (reg2dp_weight_kernel_dwc[12:0])
...
//   ,.dc_dat2mcif_rd_req_ready (dc_dat2mcif_rd_req_ready)
//   ,.dc_dat2mcif_rd_req_pd (dc_dat2mcif_rd_req_pd)
//   ,.img_dat2mcif_rd_req_valid (1'b0)
//   ,.img_dat2mcif_rd_req_ready ()
//   ,.img_dat2mcif_rd_req_pd (47'b0)
...
//   ,.mcif2img_dat_rd_rsp_ready (1'b0)
//   ,.mcif2img_dat_rd_rsp_pd (65'b0)
//   );
assign cdma_dat2mcif_rd_req_valid = dc_dat2mcif_rd_req_valid;
assign cdma_dat2mcif_rd_req_pd = dc_dat2mcif_rd_req_pd;
assign dc_dat2mcif_rd_req_ready = cdma_dat2mcif_rd_req_ready;
assign mcif2dc_dat_rd_rsp_valid = mcif2cdma_dat_rd_rsp_valid;
assign mcif2dc_dat_rd_rsp_pd = mcif2cdma_dat_rd_rsp_pd;
assign mcif2cdma_dat_rd_rsp_ready = mcif2dc_dat_rd_rsp_ready;
//-------------- SLCG for MUX --------------//
...
,.dc2cvt_dat_wr_data (dc2cvt_dat_wr_data)
  ...
  ,.dc2cvt_dat_wr_info_pd (dc2cvt_dat_wr_info_pd[11:0])
  ,.img2cvt_dat_wr_en (1'b0)

,.img2cvt_dat_wr_addr (17'b0 )
,.img2cvt_dat_wr_data (64'b0 )
,.img2cvt_mn_wr_data (128'b0 )
,.img2cvt_dat_wr_pad_mask (8'b0 )


  ,.img2cvt_dat_wr_info_pd (12'b0)
...
NV_NVDLA_CDMA_status u_status (
  ...
  ,.dc2status_dat_entries (dc2status_dat_entries)
  ,.dc2status_dat_slices (dc2status_dat_slices)
  ,.img2status_dat_updt (1'b0)
  ,.img2status_dat_entries (15'b0)
  ,.img2status_dat_slices (14'b0)
