...
output [12:0] reg2dp_weight_kernel_dwc;
...
wire [12:0] reg2dp_d0_weight_kernel_dwc;
...
wire [12:0] reg2dp_d1_weight_kernel_dwc;
...
reg [12:0] reg2dp_weight_kernel_dwc;
...
NV_NVDLA_CDMA_dual_reg u_dual_reg_d0 (
  ...
  ,.weight_kernel_dwc (reg2dp_d0_weight_kernel_dwc[12:0]) //|> w
...
NV_NVDLA_CDMA_dual_reg u_dual_reg_d1 (
  ...
  ,.weight_kernel_dwc (reg2dp_d1_weight_kernel_dwc[12:0]) //|> w
...
always @(
  dp2reg_consumer
  or reg2dp_d1_weight_kernel_dwc
  or reg2dp_d0_weight_kernel_dwc
  ) begin
    reg2dp_weight_kernel_dwc = dp2reg_consumer ? reg2dp_d1_weight_kernel_dwc : reg2dp_d0_weight_kernel_dwc;
end
always @(
  dp2reg_consumer
