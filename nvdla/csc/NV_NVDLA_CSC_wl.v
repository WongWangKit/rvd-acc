...
assign wt_req_addr_w = addr_init ? wt_entry_st_w[14 -1:0] :
                       ...
                       wt_req_addr;
assign wt_req_addr_reg_en = addr_init | wt_req_valid & (is_dwc ? wt_req_stripe_end : 1'b1) | (wt_req_pipe_valid & wt_req_channel_end);
...
assign wt_rls_cnt_reg_en = layer_st | (wt_req_pipe_valid & wt_req_group_end) | (~wt_rls_cnt_vld & wt_req_valid & (is_dwc ? wt_req_stripe_end : 1'b1));
