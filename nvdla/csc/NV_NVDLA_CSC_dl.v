...
assign {mon_c_bias_w, c_bias_w} = layer_st ? 13'b0 : is_dwc ? c_bias + c_bias_add : 
                                                            (is_stripe_end & dl_channel_end) ? 13'b0 : c_bias + c_bias_add;
assign c_bias_reg_en = layer_st | (dat_exec_valid & is_stripe_end & dl_block_end & (is_dwc ? dl_group_end : 1'b1));
