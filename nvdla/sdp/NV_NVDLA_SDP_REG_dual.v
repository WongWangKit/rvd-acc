...
wire nvdla_sdp_d_dp_bs_mul_cfg_0_wren = (reg_offset_wr == (32'h9064 & 32'h00000fff)) & reg_wr_en ; //spyglass disable UnloadedNet-ML //(W528)
wire nvdla_sdp_d_dp_bs_mul_src_value_0_wren = (reg_offset_wr == (32'h9068 & 32'h00000fff)) & reg_wr_en ; //spyglass disable UnloadedNet-ML //(W528)
...
assign dst_ram_type = 1'b0;
assign ew_alu_algo = 2'b00;
assign ew_alu_bypass = 1'b1;
assign ew_alu_cvt_bypass = 1'b1;
assign ew_alu_cvt_offset = 32'h0;
assign ew_alu_cvt_scale = 16'b0000000000000000;
assign ew_alu_cvt_truncate = 6'b000000;
assign ew_alu_operand = 32'h0;
assign ew_alu_src = 1'b0;
assign ew_bypass = 1'b1;
assign ew_lut_bypass = 1'b1;
assign ew_mul_bypass = 1'b1;
assign ew_mul_cvt_bypass = 1'b1;
assign ew_mul_cvt_offset = 32'h0;
assign ew_mul_cvt_scale = 16'b0000000000000000;
assign ew_mul_cvt_truncate = 6'b000000;
assign ew_mul_operand = 32'h0;
assign ew_mul_prelu = 1'b0;
assign ew_mul_src = 1'b0;
assign ew_truncate = 10'b0000000000;
assign out_precision = 2'b00;
assign perf_dma_en = 1'b0;
assign perf_lut_en = 1'b0;
assign perf_nan_inf_count_en = 1'b0;
assign perf_sat_en = 1'b0;
assign proc_precision = 2'b00;
