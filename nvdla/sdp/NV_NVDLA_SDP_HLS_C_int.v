...
//   .a_in    (sub_data_out),
//   .b_in    (cfg_scale_mux),
//   .in_pvld (sub_out_pvld),
//   .res_out (mul_dout),
//   .res_pvld(mul_res_pvld)
// );
// always @(posedge nvdla_core_clk or negedge nvdla_core_rstn) begin
//   if (!nvdla_core_rstn) begin
//     mul_res_prdy <= 1'b0;
//   end else begin
//     mul_res_prdy <= sub_out_prdy;
//   end
// end
...
input nvdla_core_rstn;
// input [48:0] mul_dout;
input [32:0] sub_data_out;
input [15:0] cfg_scale_mux;
input mul_out_prdy;
input sub_out_pvld;
...
wire [48:0] mul_dout;
reg  p2_skid_catch_d1;
reg  p2_pipe_ready_bc_d1;
reg  p2_skid_pipe_valid_d1;
reg  [48:0] mul_data_out_d1;
reg  p2_skid_ready_flop_d1;

always @(posedge nvdla_core_clk or negedge nvdla_core_rstn) begin
  if (!nvdla_core_rstn) begin
    p2_skid_catch_d1      <= 'b0;
    p2_pipe_ready_bc_d1   <= 'b0;
    p2_skid_pipe_valid_d1 <= 'b0;
    mul_data_out_d1       <= 'b0;
    p2_skid_ready_flop_d1 <= 'b0;
  end else begin 
    p2_skid_catch_d1      <= p2_skid_catch     ;
    p2_pipe_ready_bc_d1   <= p2_pipe_ready_bc  ;
    p2_skid_pipe_valid_d1 <= p2_skid_pipe_valid;
    mul_data_out_d1       <= mul_data_out      ;
    p2_skid_ready_flop_d1 <= p2_skid_ready_flop;
  end
end
...
multi_16_33 u_multi_16_33(
  ...
  .a_in    (sub_data_out),
  .b_in    (cfg_scale_mux),
  .in_pvld (sub_out_pvld & sub_out_prdy),
  .res_out (mul_dout),
  .res_pvld()
);
...
always @(posedge nvdla_core_clk) begin
// VCS sop_coverage_off start
  p2_skid_data <= (p2_skid_catch_d1)? mul_dout[48:0] : p2_skid_data;
// VCS sop_coverage_off end
end
always @(*) begin
...
always @(*) begin
  ...
  mul_data_out[48:0] = (p2_pipe_ready_bc_d1 && p2_skid_pipe_valid_d1) ? 
                           (p2_skid_ready_flop_d1) ? mul_dout[48:0] : p2_skid_data :
                        mul_data_out_d1[48:0];
end
