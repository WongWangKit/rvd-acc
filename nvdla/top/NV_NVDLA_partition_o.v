...
NV_NVDLA_mcif u_NV_NVDLA_mcif (
  ...
  ,.pdp2mcif_rd_req_ready (1'b0) //|> w
  ,.pdp2mcif_rd_req_pd (47'b0) //|> w
  ,.pdp2mcif_wr_req_valid (1'b0) //|> w
  ,.pdp2mcif_wr_req_ready (1'b0) //|> w
  ,.pdp2mcif_wr_req_pd (66'b0) //|> w
...
NV_NVDLA_glb u_NV_NVDLA_glb (
  ...
  ,.cdp2glb_done_intr_pd (2'b0) //|< w
  ,.pdp2glb_done_intr_pd (2'b0) //|< w
